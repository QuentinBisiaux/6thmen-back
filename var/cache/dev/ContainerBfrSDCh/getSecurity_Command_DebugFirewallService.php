...
class getSecurity_Command_DebugFirewallService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['security.command.debug_firewall'] = $instance = new \Symfony\Bundle\SecurityBundle\Command\DebugFirewallCommand($container->parameters['security.firewalls'], ($container->privates['.service_locator.95TwmuK'] ?? self::get_ServiceLocator_95TwmuKService($container)), ($container->privates['.service_locator.zq_dJRg'] ?? $container->load('get_ServiceLocator_ZqDJRgService')), ['admin' => [($container->privates['security.authenticator.form_login.admin'] ?? $container->load('getSecurity_Authenticator_FormLogin_AdminService'))], 'api' => []], false);
