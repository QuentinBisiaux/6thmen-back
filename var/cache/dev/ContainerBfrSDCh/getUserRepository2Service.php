...
{
    /**
     * Gets the private 'App\Repository\Api\UserRepository' shared autowired service.
     *
     * @return \App\Repository\Api\UserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/Api/UserRepository.php';

        return $container->privates['App\\Repository\\Api\\UserRepository'] = new \App\Repository\Api\UserRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
