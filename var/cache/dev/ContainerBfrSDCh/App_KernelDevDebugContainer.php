...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Admin\\LeagueController' => 'getLeagueControllerService',
            'App\\Controller\\Admin\\LoginController' => 'getLoginControllerService',
            'App\\Controller\\Admin\\SportController' => 'getSportControllerService',
            'App\\Controller\\Admin\\StandingController' => 'getStandingControllerService',
            'App\\Controller\\Admin\\TeamController' => 'getTeamControllerService',
            'App\\Controller\\Api\\LotteryController' => 'getLotteryControllerService',
            'App\\Controller\\Api\\PlayerController' => 'getPlayerControllerService',
            'App\\Controller\\Api\\StandingController' => 'getStandingController2Service',
            'App\\Controller\\Api\\TeamController' => 'getTeamController2Service',
    ...
    protected static function get_Container_Private_ProfilerService($container)
    {
        ...
        $instance->add(new \Symfony\Component\HttpKernel\DataCollector\EventDataCollector(new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.event_dispatcher.api' => ($container->privates['debug.security.event_dispatcher.api'] ?? self::getDebug_Security_EventDispatcher_ApiService($container));
        }, 3), $c));
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'App\\Repository\\Api\\UserRepository' => ['privates', 'App\\Repository\\Api\\UserRepository', 'getUserRepository2Service', true],
            'App\\Repository\\Library\\CountryRepository' => ['privates', 'App\\Repository\\Library\\CountryRepository', 'getCountryRepositoryService', true],
            'App\\Repository\\Library\\LeagueRepository' => ['privates', 'App\\Repository\\Library\\LeagueRepository', 'getLeagueRepositoryService', true],
            'App\\Repository\\Library\\PlayerRepository' => ['privates', 'App\\Repository\\Library\\PlayerRepository', 'getPlayerRepositoryService', true],
            'App\\Repository\\Library\\PlayerTeamsRepository' => ['privates', 'App\\Repository\\Library\\PlayerTeamsRepository', 'getPlayerTeamsRepositoryService', true],
            'App\\Repository\\Library\\SeasonRepository' => ['privates', 'App\\Repository\\Library\\SeasonRepository', 'getSeasonRepositoryService', true],
            'App\\Repository\\Library\\SportRepository' => ['privates', 'App\\Repository\\Library\\SportRepository', 'getSportRepositoryService', true],
            'App\\Repository\\Library\\StandingRepository' => ['privates', 'App\\Repository\\Library\\StandingRepository', 'getStandingRepositoryService', true],
            'App\\Repository\\Library\\TeamRepository' => ['privates', 'App\\Repository\\Library\\TeamRepository', 'getTeamRepositoryService', true],
        ], [
            'App\\Repository\\Admin\\UserRepository' => '?',
            'App\\Repository\\Api\\UserRepository' => '?',
            'App\\Repository\\Library\\CountryRepository' => '?',
            'App\\Repository\\Library\\LeagueRepository' => '?',
            'App\\Repository\\Library\\PlayerRepository' => '?',
            'App\\Repository\\Library\\PlayerTeamsRepository' => '?',
            'App\\Repository\\Library\\SeasonRepository' => '?',
            'App\\Repository\\Library\\SportRepository' => '?',
            'App\\Repository\\Library\\StandingRepository' => '?',
            'App\\Repository\\Library\\TeamRepository' => '?',
        ])));
    ...
    /**
     * Gets the private '.service_locator.95TwmuK' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_95TwmuKService($container)
    {
        return $container->privates['.service_locator.95TwmuK'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
     ...
     * @return \Symfony\Component\EventDispatcher\Debug\TraceableEventDispatcher
     */
    protected static function getDebug_Security_EventDispatcher_ApiService($container)
    {
        ...
        $instance->addListener('Symfony\\Component\\Security\\Http\\Event\\LoginSuccessEvent', [#[\Closure(name: 'security.listener.session.api', class: 'Symfony\\Component\\Security\\Http\\EventListener\\SessionStrategyListener')] fn () => ($container->privates['security.listener.session.api'] ?? $container->load('getSecurity_Listener_Session_ApiService')), 'onSuccessfulLogin'], 0);
    ...
    protected static function getSecurity_ContextListener_1Service($container)
    {
        return $container->privates['security.context_listener.1'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($container->privates['security.untracked_token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['security.user.provider.concrete.app_user_provider'] ?? $container->load('getSecurity_User_Provider_Concrete_AppUserProviderService'));
        }, 1), 'api', ($container->privates['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)), ($container->privates['debug.security.event_dispatcher.api'] ?? self::getDebug_Security_EventDispatcher_ApiService($container)), ($container->privates['security.authentication.trust_resolver'] ??= new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver()), [($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), 'enableUsageTracking']);
    }
    ...
    {
        $a = ($container->privates['.service_locator.95TwmuK'] ?? self::get_ServiceLocator_95TwmuKService($container));
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            yield 'security.firewall.map.context.admin' => ($container->privates['.security.request_matcher.HawAXws'] ?? $container->load('get_Security_RequestMatcher_HawAXwsService'));
            yield 'security.firewall.map.context.api' => ($container->privates['.security.request_matcher.5TDJm4o'] ?? $container->load('get_Security_RequestMatcher_5TDJm4oService'));
