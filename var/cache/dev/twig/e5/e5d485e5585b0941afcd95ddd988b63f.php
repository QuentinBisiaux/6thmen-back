...
class __TwigTemplate_42b5e4452e588e0bcc7937ad81d79f41 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    <h1 class=\"font-extrabold text-2xl my-4\">Edit Sport</h1>
    ...
    <div class=\"container mx-auto px-4 sm:px-6 lg:px-8\">
        ";
        // line 10
        echo twig_include($this->env, $context, "sport/_form.html.twig", ["button_label" => "Update"]);
        echo "
        ";
        // line 11
        echo twig_include($this->env, $context, "sport/_delete_form.html.twig");
        echo "
    </div>
...
{% block title %}Edit Sport{% endblock %}

{% block body %}
    <h1 class=\"font-extrabold text-2xl my-4\">Edit Sport</h1>
    <a class=\"text-zinc-400 underline\" href=\"{{ path('app_sport_index') }}\">Back to list</a>

    <div class=\"container mx-auto px-4 sm:px-6 lg:px-8\">
        {{ include('sport/_form.html.twig', {'button_label': 'Update'}) }}
        {{ include('sport/_delete_form.html.twig') }}
    </div>

{% endblock %}
", "sport/edit.html.twig", "/var/www/templates/sport/edit.html.twig");
    }
}
