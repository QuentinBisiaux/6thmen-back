...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\LotteryController' => 'getLotteryControllerService',
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\StatLotteryRepository' => ['privates', 'App\\Repository\\StatLotteryRepository', 'getStatLotteryRepositoryService', true],
            ...
            'App\\Repository\\StatLotteryRepository' => '?',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('lottery.done', [#[\Closure(name: 'App\\EventListener\\LotteryDoneListener')] fn () => ($container->privates['App\\EventListener\\LotteryDoneListener'] ?? $container->load('getLotteryDoneListenerService')), 'lotteryDone'], 0);
    ...
    /**
     * Gets the private '.service_locator.yZnLB1s' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_YZnLB1sService($container)
    {
        return $container->privates['.service_locator.yZnLB1s'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
    ...
    {
        return $container->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DaSegQqWBA', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    }
    ...
    protected static function getDebug_Security_FirewallService($container)
    {
        ...
        return $container->privates['debug.security.firewall'] = new \Symfony\Bundle\SecurityBundle\Debug\TraceableFirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(($container->privates['.service_locator.yZnLB1s'] ?? self::get_ServiceLocator_YZnLB1sService($container)), new RewindableGenerator(function () use ($container) {
        ...
        }, 1)), $a, new \Symfony\Component\Security\Http\Logout\LogoutUrlGenerator(($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->services['router'] ?? self::getRouterService($container)), ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container))));
    }
