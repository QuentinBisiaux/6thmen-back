...
final class Version20231024104811 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player (id INT NOT NULL, birth_place_id INT DEFAULT NULL, firstname VARCHAR(255) NOT NULL, lastname VARCHAR(255) DEFAULT NULL, birthday TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE starting_five (id INT NOT NULL, user_id INT NOT NULL, team_id INT NOT NULL, point_guard_id INT DEFAULT NULL, guard_id INT DEFAULT NULL, forward_id INT DEFAULT NULL, small_forward_id INT DEFAULT NULL, center_id INT DEFAULT NULL, valid BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user_data" (id INT NOT NULL, user_id INT NOT NULL, name VARCHAR(180) DEFAULT NULL, username VARCHAR(180) DEFAULT NULL, profile_image_url VARCHAR(255) NOT NULL, location VARCHAR(255) NOT NULL, raw_data JSON NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
